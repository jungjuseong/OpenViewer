...
import org.jpedal.examples.viewer.BrainViewer;
 ...
 * to Customize their Brain PDF Viewer Experience.
 */
public class BrainPreferences {
    ...
    /**
     * Declare Objects for interface Menu.
     */
    ...
    private static void init(final GUIFactory currentGUI) {
        ...
        // Initialize Objects for General Menu.         
        ...
        // Initialize Objects for Page Layout Menu.        
        ...
        final ObservableList<String> pageOptions = FXCollections.observableArrayList(
        ...
        // Initialize Objects for Interface Menu.
        ...
        // Initialize Objects for Color Menu.
        
        // Initialize Objects for Menu Menu.        
        tabs = new TabPane();
        
        // Initialize Objects for Printing Menu.         
        hiResPrintingCB = new CheckBox(Messages.getMessage("Printing.HiRes"));
        
        if(!BrainViewer.isOpenFX){
    ...
    private static String getCidVersion(final Hyperlink versionNode){
        String details = "";
        try {
            if (BrainPreferences.class.getResourceAsStream("/org/jpedal/res/cid/00_ReadMe.pdf") != null) {
    ...
    private static void updateSettings(final GUIFactory currentGUI) {
        ...
        ((BrainGUI)currentGUI).updateTransitionType();
        if (speech!=null) {
