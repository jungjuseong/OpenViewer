 ...
 */
public class BrainSearchWindow extends Stage implements GUISearchWindow {
    ...
    public void find(final PdfDecoderInt dec, final Values values) {
        /**
         * pop up new window to search text (initialize if required)
         */
        if(!backGroundSearch){
            init(dec, values);
    ...
    public void init(final PdfDecoderInt dec, final Values values) {
        ...
        if (isSetup) { //global variable so do NOT reinitialize
            searchCount.setText(Messages.getMessage("PdfViewerSearch.ItemsFound") + ' ' + itemFoundCount);
            ...
            searchButton.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(final ActionEvent e) {
                    ...
                    ((BrainGUI)currentGUI).getPdfDecoder().requestFocus();
            ...
            if (style == SEARCH_EXTERNAL_WINDOW || style == SEARCH_TABBED_PANE) {
                ...
                // Finalize the Stage, add items and scene.
